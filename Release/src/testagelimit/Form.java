...
public class Form extends javax.swing.JFrame {
    /**
     * Список содержит вопросы
     */
    private static ArrayList<String> listQuest;
    /**
     * Список содержит ответы
     */
 ...
 /**
  *Выбор варианты ответа с дальнейшей записью в список ответов на вопросы
  * @param evt игнорируется 
  *
  */
...
/**
  ...
  */
    ...
    /**
     * Завершает тест и передает список ответов для получения результата
     */
  ...
  /**
  *Загружает список из класса FileTest и запускает инициализацию список ответов(vectorAns)
  *
  */
    ...
    /**
     * Получает данные с список и выводит их в компоненты формы
     ...
     * @param i номер вопроса
     * @return  возвращает ответ на вопрос, записанный в списке ответов
     */ 
